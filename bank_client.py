...
class BankClient:
    def __init__(self, server_url):
        ...
        self.lock = threading.Lock()  # Añadido para sincronizar las solicitudes RPC (control de acceso)
    ...
    def login(self, account_id, password, notifications_enabled=True):
        if self.authenticate(account_id, password):
            ...
            if notifications_enabled:
                ...
                self.notification_thread.start()           # Inicia un hilo para recibir notificaciones.
            return True
        else:
    ...
    def stop_notifications(self):   #Controla la finalización del hilo de notificaciones.
    ...
    def listen_for_notifications(self):
        while not self.stop_notification_thread:
            ...
            time.sleep(1)  # Tiempo en el que consulta y muestra notificaciones
...
if __name__ == "__main__":
    ...
    #client = BankClient('http://172.25.233.8:8000')
    main_menu(client)
